...
<button type="button" class="btn btn-primary btn-sm" id="helpdesk-button" data-toggle="modal" data-target="#helpdesk-modal">
    Enter Helpdesk Data
</button>

<div class="modal fade" id="helpdesk-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Helpdesk Data</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(['url' => '/client/' . $client->id . '/helpdesk/data', 'method' => 'post']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::submit('Submit Helpdesk Data', ['class' => 'form-control btn btn-primary']) !!}
                    </div>
