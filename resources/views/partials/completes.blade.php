...
<button type="button" class="btn btn-primary btn-sm" id="completes-button" data-toggle="modal" data-target="#completes-modal">
    Enter Completes Data
</button>

<div class="modal fade" id="completes-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Completes Data</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(['url' => '/client/' . $client->id . '/completes/data', 'method' => 'post']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::submit('Submit Completes Data', ['class' => 'form-control btn btn-primary']) !!}
                    </div>
