...
<button type="button" class="btn btn-primary btn-sm" id="support-button" data-toggle="modal" data-target="#support-modal">
    Enter Support Data
</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Support Data</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(['url' => '/client/' . $client->id . '/support/data', 'method' => 'post']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::submit('Submit Support Data', ['class' => 'form-control btn btn-primary']) !!}
                    </div>
